 ...
 */
public class CateListAdapter2 extends RecyclerView.Adapter<CateListAdapter2.MyViewHolder> {
    ...
    public CateListAdapter2(Context context, ArrayList<HashMap<String, String>> cat_name) {
        this.c = context;
