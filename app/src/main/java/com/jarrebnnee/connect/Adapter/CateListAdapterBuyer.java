 ...
 */
public class CateListAdapterBuyer extends RecyclerView.Adapter<CateListAdapterBuyer.MyViewHolder> {
            ...
            ck.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (checkBox.isChecked()) {
                        ...
                        UserInterestsActivity.cate_id.add(sc_category_id);
                        Log.e("add", sc_category_id + "<<" + UserInterestsActivity.cate_id.size());
                    } else {
                        map.setCheckedBox(false);

                        UserInterestsActivity.cate_id.remove(sc_category_id);
                        Log.e("remove", sc_category_id + ">>" + UserInterestsActivity.cate_id.size());
                    }
    ...
    public CateListAdapterBuyer(Context context, ArrayList<CatListGS> cat_name) {
        this.c = context;
