...
public class SerachCateGVAdapter extends BaseAdapter{
    ...
    public SerachCateGVAdapter(Context context,  ArrayList<HashMap<String,String>> cat_name) {
        this.c = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.custom_search_gv, parent, false);

        tvcname = (TextView)itemView.findViewById(R.id.tvcname);
        ivcname = (ImageView)itemView.findViewById(R.id.ivcname);
        ...
        if (temp == 1) {
            ...
            tvcname.setText(map.get("c_ar_title"));
        } else {
