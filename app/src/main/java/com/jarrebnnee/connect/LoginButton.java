...
/**
 * Created by Vardhman Infonet 4 on 01-Mar-17.
 */
...
public class LoginButton extends FacebookButtonBase {
    ...
    public enum ToolTipMode {
     ...
     public static void performLogin(FragmentActivity ) {
    }    */
    ...
    private static final String TAG = com.facebook.login.widget.LoginButton.class.getName();
     ...
     */
    public void setToolTipMode(com.facebook.login.widget.LoginButton.ToolTipMode toolTipMode) {
        this.toolTipMode = toolTipMode;
    }

    /**
     * Return the current {@link com.facebook.login.widget.LoginButton.ToolTipMode} for this LoginButton
     *
     * @return The {@link com.facebook.login.widget.LoginButton.ToolTipMode}
     */
    public com.facebook.login.widget.LoginButton.ToolTipMode getToolTipMode() {
        return toolTipMode;
    }
    ...
    protected void configureButton(
        ...
        setCompoundDrawablesWithIntrinsicBounds(
                AppCompatResources.getDrawable(getContext(), com.facebook.R.drawable.com_facebook_button_login_logo),
                null,
                null,
                null);
    }
    ...
    private void parseLoginButtonAttributes(
            ...
            final int defStyleAttr,
            final int defStyleRes) {
        this.toolTipMode = com.facebook.login.widget.LoginButton.ToolTipMode.DEFAULT;
        ...
        try {
            ...
            toolTipMode = com.facebook.login.widget.LoginButton.ToolTipMode.fromInt(a.getInt(
                    com.facebook.R.styleable.com_facebook_login_view_com_facebook_tooltip_mode,
                    com.facebook.login.widget.LoginButton.ToolTipMode.DEFAULT.getValue()));
        } finally {
            a.recycle();
        }
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int width;
        if (text == null) {
            text = resources.getString(com.facebook.R.string.com_facebook_loginview_log_in_button_continue);
        ...
        if (!isInEditMode() && AccessToken.getCurrentAccessToken() != null) {
         ...
         /*   if (loginText != null) {
                ...
                String text = resources.getString(
                        com.facebook.R.string.com_facebook_loginview_log_in_button_continue);
                int width = getWidth();
