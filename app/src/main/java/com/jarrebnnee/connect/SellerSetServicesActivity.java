...
import com.jarrebnnee.connect.Adapter.CateListAdapter2;
...
import com.jarrebnnee.connect.Adapter.RBAdapter;
...
public class SellerSetServicesActivity extends AppCompatActivity {
    ...
    String s_description, s_id, s_city_id, s_country_id, s_user_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seller_set_services);
        ...
        s_user_id = saveSharedPrefrence.getUserID(SellerSetServicesActivity.this);
        cate_id = new ArrayList<String>();
        lang = saveSharedPrefrence.getlang(SellerSetServicesActivity.this);


        etDesc = (EditText) findViewById(R.id.etDesc);
        btn_submit = (Button) findViewById(R.id.btn_submit);
        btn_my_services = (Button) findViewById(R.id.btn_my_services);
        ...
        Typeface custom_font = Typeface.createFromAsset(SellerSetServicesActivity.this.getAssets(), "fonts/16023_futuran_0.ttf");
        ...
        ConnectivityManager connectivityManager = (ConnectivityManager) SellerSetServicesActivity.this.getSystemService(Context.CONNECTIVITY_SERVICE);
...
//we are connected to a network
            ...
            new Country(SellerSetServicesActivity.this).execute();

            new MainCategory(SellerSetServicesActivity.this).execute();

        } else {
            Toast.makeText(SellerSetServicesActivity.this, "Please check your internet connection!", Toast.LENGTH_LONG).show();
        }
        final boolean b = saveSharedPrefrence.getSellerHasService(SellerSetServicesActivity.this);
        btn_my_services.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (b) {
                    Intent intent = new Intent(SellerSetServicesActivity.this, SellerServiceSetActivity.class);
                    startActivity(intent);
                } else {
                    Toast.makeText(SellerSetServicesActivity.this, "You need to add service to view", Toast.LENGTH_SHORT).show();
                }
        ...
        spCountry.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                new City(SellerSetServicesActivity.this).execute();
            }
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (s_category_id.equals("")) {
                    Toast.makeText(SellerSetServicesActivity.this, getResources().getString(R.string.pservice), Toast.LENGTH_LONG).show();
                } else {
                    new SetService(SellerSetServicesActivity.this).execute();
                }
            }
        });
    ...
    class MainCategory extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(SellerSetServicesActivity.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            pDialog.dismiss();
            RBAdapter cateListAdapter = new RBAdapter(list,SellerSetServicesActivity.this);
    ...
    class Country extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            if (status.equals("0")) {
                Log.e("get id", "" + id);
                countryListAdapter = new EditCountryListAdapter(SellerSetServicesActivity.this, countrylist);
    ...
    class City extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            if (status.equals("0")) {
                ...
                cityListAdapter = new EditCityListAdapter(SellerSetServicesActivity.this, citylist);
    ...
    class SetService extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            Log.d("nameValuePairs: ", "> " + nameValuePairs);
            Log.d("Response: ", "> " + jsonSt);
            Log.e("xxxxxx", "s_category_id"+s_category_id);
            if (jsonSt != null) {
        ...
        protected void onPostExecute(Void result) {
            ...
            pDialog.dismiss();
            if (status.equals("0")) {
                //       Toast.makeText(SellerSetServicesActivity.this, getResources().getString(R.string.supdatesucess), Toast.LENGTH_LONG).show();
                Toast.makeText(SellerSetServicesActivity.this, msg, Toast.LENGTH_SHORT).show();
                ...
                Intent intent = new Intent(SellerSetServicesActivity.this, HomeActivity.class);
                startActivity(intent);
                finish();
            } else {
                Toast.makeText(SellerSetServicesActivity.this, msg, Toast.LENGTH_SHORT).show();
