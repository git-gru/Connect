...
public class ServiceItemDetailActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_service_item_detail);
        ...
        btnSms.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
              /*  if (ActivityCompat.checkSelfPermission(ServiceItemDetailActivity.this, android.Manifest.permission.SEND_SMS) == PackageManager.PERMISSION_GRANTED) {
                    Log.d(TAG, "Permission to send SMS is required to run the app");
               */     if (number.length() > 3) {
       ...
       /* permissionList = new ArrayList<>();
        ...
        if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
            Log.d(TAG, "Permission to make calls is required to run the app");
        ...
        btnCall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (number.length() > 3) {
                //    Toast.makeText(ServiceItemDetailActivity.this, "Dial: " + number, Toast.LENGTH_SHORT).show();
                    try {
...
/*
                    if (ActivityCompat.checkSelfPermission(ServiceItemDetailActivity.this,
                    ...
                    Toast.makeText(ServiceItemDetailActivity.this, "Sorry, we do not have contact details for this seller", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//we are connected to a network
  ...
  /*  private void requestPermission(List<String> permissions) {
    ...
    void onPermissionGranted() {
        Toast.makeText(ServiceItemDetailActivity.this, "permissions granted for android 7", Toast.LENGTH_SHORT).show();
    }*/
    ...
    class ServiceDetail extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(ServiceItemDetailActivity.this);
           ...
           /*     iv1.setDrawingCacheEnabled(true);
                ...
                *//* iv1.buildDrawingCache();
                Bitmap bitmap=iv1.getDrawingCache();*/
                        Intent in=new Intent(ServiceItemDetailActivity.this,FullImageActivity.class);
                ...
                mapFragment.getMapAsync(ServiceItemDetailActivity.this);
